...
# Train RF
set.seed(123)
rf_orig <- ranger(formula = Coronary_Heart_Disease ~ ., data = train_rf, num.trees = 500, mtry = floor(sqrt(ncol(train_rf) - 1)), importance = "impurity", probability = TRUE)
...
print(best)
optimal_cutoff_rf <- as.numeric(best["threshold"])
