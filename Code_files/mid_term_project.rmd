...
if("Flu_Vaccination" %in% names(Heart_data)) {
  Heart_data$Flu_Vaccination <- factor(Heart_data$Flu_Vaccination, levels = c(1, 2), labels = c("Yes", "No"))
}
if("Difficulty_Walking_Stairs" %in% names(Heart_data)) {
  Heart_data$Difficulty_Walking_Stairs <- factor(Heart_data$Difficulty_Walking_Stairs, levels = c(1, 2), labels = c("Yes", "No"))
}
if("Poor_Physical_Health_Days" %in% names(Heart_data)) {
  Heart_data$Poor_Physical_Health_Days <- as.numeric(Heart_data$Poor_Physical_Health_Days)
}
...
selected_vars <- c(
  ...
  "Flu_Vaccination", "Difficulty_Walking_Stairs", "Poor_Physical_Health_Days"
)
...
continuous_vars <- c("BMI_Value", "Poor_Physical_Health_Days")
